...
func _ready() -> void:
	distance_to_coin.visible = Settings.SETTINGS['DistanceToCoin']
	distance_to_start.visible = Settings.SETTINGS['DistanceToStart']
...
func _process(delta: float) -> void:
	...
	if Spawner.last_spawned_coin:
		var _distance_to_coin := Vector2(Spawner.coin_position - Global.Player.global_position)
